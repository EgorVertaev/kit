        ...
        <div className="overview__chart">
          <div className="overview__wrapper">
             ...
             <ul className="overview__info-list">
                ...
                <li className="overview__info-item">
                  <span className="overview__info-title">Average first response time</span>
                  <span className="overview__info-value">33m</span>
                </li>
                <li className="overview__info-item">
                  <span className="overview__info-title">Average response time</span>
                  <span className="overview__info-value">3h 8m</span>
                </li>
                <li className="overview__info-item">
                  <span className="overview__info-title">Resolution within SLA</span>
